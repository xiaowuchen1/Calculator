...
public class jsq extends JFrame{
    ...
    private jsq(){
        ...
        jb[19].addActionListener(e->{
            try{
                double x= calculate("0"+jt.getText()+"#");
                jt.setText("");
    ...
    private Double calculate(String text){
        ...
        for(int i=0;i<text.length()-1;i++){
            String temp0=String.valueOf(text.charAt(i));
            String temp1=String.valueOf(text.charAt(i+1));
            if(temp0.equals("(")&&temp1.equals("-")) {	
            	strb.insert(i+1, "0");
       ...
       /*for(int i=0;i<strb.length();i++){
            String temp=String.valueOf(strb.charAt(i)); 
